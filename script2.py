...
# Function to populate the dictionary with data from the files
def addtodict():
...
def fastest(lap):
    #this fnction gives the fastest lap time for each grandprix.
    driver=[]
    top=1000
...
# Function to print the fastest time for each driver
